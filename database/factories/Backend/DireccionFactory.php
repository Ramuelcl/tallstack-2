...
class DireccionFactory extends Factory
{
    ...
    public function definition()
    {
        ...
        $pos = strrpos($myString = $dirs[1], $findMy = ' ');
        // $pos = fncElimCaracterDuplicado(substr($dirs[1], 0, $pos));
        $codPostal = sprintf("%05d", (int)filter_var(substr($dirs[1], 0, $pos), FILTER_SANITIZE_NUMBER_INT));
